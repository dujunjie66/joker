...
var n05 = document.getElementById('n05'); //加法的第一个输入框
var n06 = document.getElementById('n06'); //加法的第二个输入框
var jieguo03 = document.getElementById('jieguo03'); //加法的结果
var n07 = document.getElementById('n07'); //加法的第一个输入框
var n08 = document.getElementById('n08'); //加法的第二个输入框
var jieguo04 = document.getElementById('jieguo04'); //加法的结果
var sperr = document.getElementById('sperr'); //错误提示信息
// 显示元素是不是正确
console.log(jisuan, n01, n02, jieguo01, n03, n04, jieguo02, n05, n06, jieguo03, n07, n08, jieguo04, sperr);
